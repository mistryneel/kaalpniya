export function generatePrompt(body: any) {
  ...
  return (
    ...
    "1. `personalBrandPositioning` (Object): A detailed personal brand positioning statement.\n" +
    ...
    "2. `contentStrategy` (Object): A content strategy tailored to the individual's expertise and target audience.\n" +
    ...
    "3. `onlinePresence` (Object): Guidance on building a strong online presence.\n" +
    ...
    "4. `networkingAndCollaboration` (Object): Strategies for expanding the individual's professional network.\n" +
