...
export default function InputCapture({
  ...
  return (
    <section>
      <Hello userEmail={userEmail} credits={credits} />
          ...
          toolConfig.type === "vision" ? (
            ...
            <AppInfo title="Your image has been generated.">
              ...
              <p className="text-sm mt-4">
                Fill in the form on the right side to generate a different
                image.
              </p>
            </AppInfo>
          ) : null}
          ...
          <div className="flex items-center">
            <form onSubmit={handleSubmit}>
              <div className="flex justify-center items-center">
                <div className="mt-10 w-96 px-2 mb-5 text-left">
                  {toolConfig.type === "vision" && (
                    <Upload
              ...
              <div className="mb-5 ml-2 flex justify-center lg:justify-start">
                <Button
                  disabled={
